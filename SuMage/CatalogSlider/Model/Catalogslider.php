...
namespace SuMage\CatalogSlider\Model;

/**
 * CatalogSlider model
 * @package SuMage\CatalogSlider\Model
 */
class Catalogslider extends \Magento\Framework\Model\AbstractModel {
    ...
    const SLIDER_TYPE_SPECIALPRICE = 'specialPrice';
    const SLIDER_TYPE_RECENTLYVIEWED = 'recentlyviewed';
    ...
    {
        $this->_init('SuMage\CatalogSlider\Model\ResourceModel\Catalogslider');
    }
    ...
    protected static $sliderTypes = [
        ...
        self::SLIDER_TYPE_ONSALE => 'Most Rated Products',
        self::SLIDER_TYPE_FEATURED => 'Featured Products',
        self::SLIDER_TYPE_SPECIALPRICE => 'Special Price Products',
        self::SLIDER_TYPE_RECENTLYVIEWED => 'Recently Viewed Products',
    ];
     ...
     * @return array
     */
    public static function getProductNumberArray()
    {
        return [['value' => 5, 'label' => __(5)], 
...
//        return [0=>5,1=>10,2=>15,3=>20,4=>25,5=>30];
    }
